  ...
  return (
    <div className="space-y-6">
      <div className="flex items-start justify-between gap-3">
        ...
        <p className="text-sm text-muted-foreground">M3: Registration السجلات ومتابعة مواقعها.</p>
        </div>
      ...
      <div className="rounded-xl border bg-background overflow-x-auto">
        <table className="w-full text-sm">
          <thead className="border-b bg-muted/40"><tr><th className="p-3 text-start">Reference</th><th className="p-3 text-start">Title</th><th className="p-3 text-start">Box</th><th className="p-3 text-start">Secrecy</th><th className="p-3 text-start">الإجراء</th></tr></thead>
