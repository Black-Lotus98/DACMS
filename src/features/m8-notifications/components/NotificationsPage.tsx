    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-sm text-muted-foreground">M8: سجل الإشعارات مع عدد غير المقروء.</p>
        </div>
        <div className="flex items-center gap-2">
          <span className="text-sm bg-primary-a0 text-white px-3 py-1 rounded-full">غير مقروء: {unreadCount}</span>
          <button
      ...
      <section className="rounded-xl border bg-background p-4">
        <h2 className="font-semibold mb-2">سجل الإشعارات</h2>
      ...
      <section className="rounded-xl border bg-background p-4">
        <h2 className="font-semibold mb-2">إعدادات التنبيه</h2>
