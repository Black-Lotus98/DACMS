  ...
  function createWorkflow() {
    ...
    dispatch(
      addWorkflow({
        ...
        steps: [
          { id: `st-${Date.now()}-1`, name: 'Initial review', type: StepType.Review, slaHours: 8, order: 1 },
          { id: `st-${Date.now()}-2`, name: 'Approve', type: StepType.Approval, slaHours: 12, order: 2 },
        ],
      })
    );
    setWorkflowName('');
